...
public class AlarmReceiver extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, final Intent intent) {
        ...
        // Use the alarm's label or the default label as the ticker value and
        // main value of the notification.

        final Notification n = new Notification.Builder(context)
                .setContentTitle(context.getString(R.string.default_label))
                .setContentText(context.getString(R.string.alarm_notify_text))
                .setContentIntent(pendingNotify).setWhen(alarm.time)
                .setSmallIcon(R.drawable.ic_stat_notify_alarms).build();
        ...
        final Notification n = new Notification.Builder(context)
                ...
                .setContentText(
                        context.getString(R.string.alarm_alert_alert_silenced,
                                timeout)).setContentIntent(intent)
                .setWhen(alarm.time)
                .setSmallIcon(R.drawable.ic_stat_notify_alarms).build();
