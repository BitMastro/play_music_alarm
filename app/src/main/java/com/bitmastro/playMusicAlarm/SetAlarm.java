...
public class SetAlarm extends PreferenceActivity implements
	...
	private NumberPickerDialogPreference mDurationPref;
	private SeekBarDialogPreference mVolumePref;
	...
	protected void onCreate(Bundle icicle) {
		...
		mTimePref.setOnPreferenceChangeListener(this);
		mDurationPref = (NumberPickerDialogPreference) findPreference("duration");
		mDurationPref.setOnPreferenceChangeListener(this);
		mVolumePref = (SeekBarDialogPreference) findPreference("volume");
		int streamMaxVolume = ((AudioManager) getSystemService(Context.AUDIO_SERVICE))
				.getStreamMaxVolume(AudioManager.STREAM_MUSIC);
		mVolumePref.setMaxValue(streamMaxVolume);
	...
	private void updatePrefs(Alarm alarm) {
		...
		mTimePref.setHour(alarm.hour);
		mTimePref.setMinute(alarm.minutes);
		mRepeatPref.setDaysOfWeek(alarm.daysOfWeek);
		mVibratePref.setChecked(alarm.vibrate);
		// Give the alert uri to the preference.
		mDurationPref.setValue(alarm.duration);
		mVolumePref.setValue(alarm.volume);
	}
	...
	private Alarm buildAlarmFromUi() {
		...
		alarm.hour = mTimePref.getHour();
		alarm.minutes = mTimePref.getMinute();
		alarm.daysOfWeek = mRepeatPref.getDaysOfWeek();
		alarm.vibrate = mVibratePref.isChecked();
		alarm.duration = mDurationPref.getValue();
		alarm.volume = mVolumePref.getValue();
		return alarm;
	}
