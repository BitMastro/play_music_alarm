...
class AlarmDatabaseHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		db.execSQL("CREATE TABLE alarms (" + "_id INTEGER PRIMARY KEY,"
				...
				+ "enabled INTEGER, " + "vibrate INTEGER, " + "alert TEXT, "
				+ "duration INTEGER, " + "volume INTEGER);");

		// insert default alarms
		String insertMe = "INSERT INTO alarms "
				+ "(hour, minutes, daysofweek, alarmtime, enabled, vibrate, "
				+ " duration,volume) VALUES ";
		db.execSQL(insertMe + "(8, 30, 31, 0, 0, 1, 30, 100);");
		db.execSQL(insertMe + "(9, 00, 96, 0, 0, 1, 30, 100);");
	}
