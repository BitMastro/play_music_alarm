...
public final class Alarm implements Parcelable {
	...
	public static class Columns implements BaseColumns {
		...
		public static final Uri CONTENT_URI = Uri
				.parse("content://com.bitmastro.playMusicAlarm/alarm");
		...
		static final String[] ALARM_QUERY_COLUMNS = { _ID, HOUR, MINUTES,
				DAYS_OF_WEEK, ALARM_TIME, ENABLED, VIBRATE, DURATION, VOLUME };
		...
		public static final int ALARM_DURATION_INDEX = 7;
		public static final int ALARM_VOLUME_INDEX = 8;
	}
